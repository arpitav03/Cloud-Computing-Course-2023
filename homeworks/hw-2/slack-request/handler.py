...
def handle(req):
    data = {
        ...
        "attachments": [{
            ...
            "author_name": "Arpita Verma",
            "author_icon": "https://avatars.githubusercontent.com/u/86750299?v=4",
            "image_url": "https://hub.docker.com/r/arpitaverma03/slack-interactive/"
        },
        {
